...
# R5 Ouvrir le fichier INDEMNITE PERMANENCE MOIS ANNEE
indemnite_workbook = openpyxl.load_workbook('INDEMNITE PERMANENCE SIEGE JUILLET 2025.xlsx')
...
# R5 Enregistrer les modifications dans le fichier INDEMNITE PERMANENCE MOIS ANNEE
indemnite_workbook.save('INDEMNITE PERMANENCE SIEGE JUILLET 2025.xlsx')